 ...
 * Last Updated: 2025-12-24T02:54:49
 *
...
import { ArrowDown, Check, Menu, Play, Shield, Star, X, Zap } from 'lucide-react';
...
const Header = React.memo(() => {
  ...
  return (
    <header className="fixed top-0 w-full z-50 bg-white/95 backdrop-blur-md border-b border-gray-200/50">
      ...
      {mobileMenuOpen && (
        <div
          className="md:hidden bg-white/95 backdrop-blur-md border-t border-gray-200/50 animate-in slide-in-from-top-2 duration-300"
        >
    ...
    <section className="pt-24 pb-16 bg-gradient-to-br from-gray-50 via-white to-blue-50">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <Badge
            variant="secondary"
            className="mb-8 px-4 py-2 text-sm bg-blue-100 text-blue-700 hover:bg-blue-200"
          >
          ...
          <div className="relative max-w-5xl mx-auto">
            <div className="bg-white rounded-2xl shadow-2xl overflow-hidden border border-gray-200">
              ...
              <div
                className="aspect-video bg-gradient-to-br from-blue-100 to-purple-100 flex items-center justify-center relative"
              >
                ...
                >
                  <div
                    className="w-16 h-16 bg-white/90 rounded-full flex items-center justify-center shadow-lg hover:scale-105 transition-transform"
                  >
    ...
    <section className="py-24 bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="text-center">
            <div
              className="w-16 h-16 bg-blue-600 rounded-full flex items-center justify-center mx-auto mb-6 text-2xl font-bold"
            >
              1
            </div>
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            From chaos to
            {' '}
            <span className="text-blue-600">perfect order</span>
          </h2>
          ...
          <div className="bg-gray-100 rounded-2xl p-8 text-center">
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white rounded-lg p-6 shadow-lg">
                ...
                <div
                  className="bg-gradient-to-br from-blue-100 to-purple-100 h-48 rounded-lg flex items-center justify-center"
                >
              ...
              <div className="bg-white rounded-lg p-6 shadow-lg">
                ...
                <div
                  className="bg-gradient-to-br from-green-100 to-blue-100 h-48 rounded-lg flex items-center justify-center"
                >
      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <Accordion type="single" collapsible className="space-y-4">
          ...
          <AccordionItem value="integration" className="border border-gray-200 rounded-lg px-6">
            ...
            <AccordionContent className="text-gray-600">
              Yes, we have ready integrations with Excel, Google Sheets, Slack, Zapier and API for custom
              solutions.
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex items-center gap-4 mt-4 md:mt-0">
            <a href="https://twitter.com/saasflow" className="text-gray-400 hover:text-white transition-colors" aria-label="Follow us on Twitter">
            ...
            <a href="https://github.com/saasflow" className="text-gray-400 hover:text-white transition-colors" aria-label="View our GitHub repository">
            ...
            <a href="https://linkedin.com/company/saasflow" className="text-gray-400 hover:text-white transition-colors" aria-label="Connect with us on LinkedIn">
