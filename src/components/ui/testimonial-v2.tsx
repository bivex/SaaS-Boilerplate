...
const testimonials: Testimonial[] = [
  {
    ...
    image: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&q=80&w=40&h=40',
    name: 'Briana Patton',
    role: 'Operations Manager',
  },
  {
    text: 'Implementing this ERP was smooth and quick. The customizable, user-friendly interface made team training effortless.',
    image: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&q=80&w=40&h=40',
    name: 'Bilal Ahmed',
    role: 'IT Manager',
  },
  {
    text: 'The support team is exceptional, guiding us through setup and providing ongoing assistance, ensuring our satisfaction.',
    image: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?auto=format&fit=crop&q=80&w=40&h=40',
    name: 'Saman Malik',
    role: 'Customer Support Lead',
  },
  {
    text: 'This ERP\'s seamless integration enhanced our business operations and efficiency. Highly recommend for its intuitive interface.',
    image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=40&h=40',
    name: 'Omar Raza',
    role: 'CEO',
  },
  {
    text: 'Its robust features and quick support have transformed our workflow, making us significantly more efficient.',
    image: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&q=80&w=40&h=40',
    name: 'Zainab Hussain',
    role: 'Project Manager',
  },
  {
    text: 'The smooth implementation exceeded expectations. It streamlined processes, improving overall business performance.',
    image: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&q=80&w=40&h=40',
    name: 'Aliza Khan',
    role: 'Business Analyst',
  },
  {
    text: 'Our business functions improved with a user-friendly design and positive customer feedback.',
    image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&q=80&w=40&h=40',
    name: 'Farhan Siddiqui',
    role: 'Marketing Director',
  },
  {
    text: 'They delivered a solution that exceeded expectations, understanding our needs and enhancing our operations.',
    image: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&q=80&w=40&h=40',
    name: 'Sana Sheikh',
    role: 'Sales Manager',
  },
  {
    text: 'Using this ERP, our online presence and conversions significantly improved, boosting business performance.',
    image: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&q=80&w=40&h=40',
    name: 'Hassan Ali',
            ...
            <React.Fragment key={index === 0 ? 'visible' : 'hidden'}>
              {props.testimonials.map(({ text, image, name, role }) => (
                <motion.li
                  ...
                  className={`p-10 rounded-3xl border border-neutral-200 dark:border-neutral-800 shadow-lg shadow-black/5 max-w-xs w-full bg-white dark:bg-neutral-900 transition-all duration-300 cursor-default select-none group focus:outline-none focus:ring-2 focus:ring-primary/30 ${index === 1 ? 'pointer-events-none' : ''}`}
                >
...
export { type Testimonial, TestimonialsSection };
